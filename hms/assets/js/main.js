...
var Main = (function() {
  ...
  var settingsHandler = function() {
    ...
    $("#skin_color").attr("href", "/hospital/hms/assets/css/themes/" + appSetting.theme + ".css");
    ...
    $('input[name="setting-theme"]').change(function() {
      ...
      $("#skin_color").attr("href", "/hospital/hms/assets/css/themes/" + selectedTheme + ".css");
    ...
    function defaultSetting() {
      ...
      $("#skin_color").attr("href", "/hospital/hms/assets/css/themes/theme-1.css");
      $(".navbar-brand img").attr("src", "assets/images/logo.png");
    }
  };
